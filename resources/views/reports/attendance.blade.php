                ...
                <tbody>
                    @forelse($rows as $r)
                        <tr class="border-t">
                            ...
                            {{-- 12-hour format for AM/PM times --}}
                            <td class="px-3 py-2">
                                {{ $r->am_in ? \Carbon\Carbon::parse($r->am_in)->format('g:i A') : '' }}
                            </td>
                            <td class="px-3 py-2">
                                {{ $r->am_out ? \Carbon\Carbon::parse($r->am_out)->format('g:i A') : '' }}
                            </td>
                            <td class="px-3 py-2">
                                {{ $r->pm_in ? \Carbon\Carbon::parse($r->pm_in)->format('g:i A') : '' }}
                            </td>
                            <td class="px-3 py-2">
                                {{ $r->pm_out ? \Carbon\Carbon::parse($r->pm_out)->format('g:i A') : '' }}
                            </td>
